...
Definition: **Public Conracts** _noun_ - All public APIs and protocols. In other words, read the BEPs (and the things they reference) and you'll have a good start.
